 ...
 */
final class Version20200220153118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD date DATETIME NOT NULL, CHANGE responses_id responses_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message DROP date, CHANGE responses_id responses_id INT DEFAULT NULL');
